...
tags:
  - review
---
Команда в [[Linux]] для создания новых [[namespace]] и запуска процесса внутри них. Используется для изоляции процессов и демонстрации того, как работают контейнеры.
