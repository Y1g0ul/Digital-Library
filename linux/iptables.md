...
| `-X`      | Удалить цепочку                                   |
Так же можно фильтровать по состоянию пакетов, для создания VPN, для ограничения скорости.
...
iptables -N MY_CHAIN                         # Создать цепочку
iptables -X MY_CHAIN                         # Удалить цепочку
```
